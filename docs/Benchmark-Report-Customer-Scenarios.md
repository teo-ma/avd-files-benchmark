...
| 场景 | 压测 3000 IOPS | 压测 500 IOPS | **客户真实 500 IOPS** |
|---|---:|---:|---:|
| 大文件拷贝（1M 顺序读） | — | — | **170.27 MiB/s** ⭐ |
| 大文件拷贝（1M 顺序写） | — | — | **92.23 MiB/s** ⭐ |
| CAD 加载（64K 顺序读） | — | — | **109.79 MiB/s** ⭐ |
| Office 编辑（64K 70R30W 低 QD） | — | — | **56.12 MiB/s，4.5 ms** ⭐ |
| Office 保存（100M 顺序写） | — | — | **12.27 MiB/s** ⭐ |
| 64K 随机读（压测）| 141.94 | 131.98 | 144.31 |
| 4K 随机读 IOPS（压测） | 7,568 | 5,081 | 4,046 |
